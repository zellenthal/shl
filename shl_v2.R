...
for (teamID in shl_team_dictionary_1920$shlse_team_id[1:14]) {
    ...
    for (date1 in as.list(shl_dates_1920[1:33])) {
...
for (teamID in shl_team_dictionary_1920$shlse_team_id[1:14]) {
  ...
  for (date1 in as.list(shl_dates_1920[35])) {
...
#Unique Names
write.csv(unique(player_toi_data_1920$name), file = "player_names_1920.csv")
...
player_toi_data_1920 %>%
  left_join(player_lookup, by = c("name" = "shlse")) %>% view()